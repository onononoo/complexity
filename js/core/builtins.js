...
const builtins = {
  sphere:   { sigs: [[["v3", "f"], "f"]], glsl: "sdsphere", doc: "sphere(q, r)", about: "a sphere with radius r." },
  box:      { sigs: [[["v3", "v3"], "f"], [["v3", "f"], "f"]], glsl: "sdbox", doc: "box(q, half)", about: "box, the half-extents can be a vec3 or float." },
  torus:    { sigs: [[["v3", "f", "f"], "f"]], glsl: "sdtorus", doc: "torus(q, major, minor)", about: "torus that lay in the xz plane." },
  ...
  shell:    { sigs: [[["f", "f"], "f"]], glsl: "opshell", fold: math_lib.shell, doc: "shell(d, w)", about: "make a shape hollow with thickness w." },
  rotx:     { sigs: [[["v3", "f"], "v3"]], glsl: "oprotx", doc: "rotx(q, a)", about: "rotate a point. theres also roty and rotz." },
  ...
  vec3:     { sigs: [[["f"], "v3"], [["f", "f", "f"], "v3"]], glsl: "vec3", doc: "vec3(x, y, z)", about: "make a vector. vec2(x, y) work too." },
  ...
  min:      { sigs: [[["g", "g"], "g"], [["g", "f"], "g"]], glsl: "min", fold: Math.min, doc: "min, max, clamp, mix", about: "does each component." },
