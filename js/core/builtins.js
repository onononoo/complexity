...
const builtins = {
  ...
  torus:    { sigs: [[["v3", "f", "f"], "f"]], glsl: "sdtorus", doc: "torus(q, major, minor)", about: "torus in the xz plane." },
  ...
  smin:     { sigs: [[["f", "f", "f"], "f"]], glsl: "opsmin", fold: math_lib.smin, doc: "smin(a, b, k)", about: "smooth union with blend radius k." },
  smax:     { sigs: [[["f", "f", "f"], "f"]], glsl: "opsmax", fold: math_lib.smax, doc: "smax(a, b, k)", about: "smooth intersection." },
  shell:    { sigs: [[["f", "f"], "f"]], glsl: "opshell", fold: math_lib.shell, doc: "shell(d, w)", about: "hollows a shape to thickness w." },
